        ...
        <div class="ui-widget-header ui-corner-all" style=" margin-bottom: 0px;">
            <div class="ui-widget-header ui-corner-all" style=" margin-bottom: 0px; height: 38px;">
                <div style="margin-top: 3px; margin-left: 6px;">
                    ...
                    <button id="btn_asignar"><img src="./images/users.png"/>&nbsp;asignar a Catedr&aacute;tico</button>
    ...
    $(document).ready(function() {
        ...
        function getConsultasProy(json){
            ...
            $.each(json, function(k,v){
                a[k]=[v.bq,v.se,v.np,v.no,v.lo,'<img src="images/eliminar_usuario.png" class="opc" title="Desasignar" alt="Desasignar" onclick="desasignar_actividad(\''+v.id+'\')"/>'
                ];});
            return a;
        }
