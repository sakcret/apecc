...
<br>
SELECT sum(Horas) as cuantas_horas, Fecha as fecha,SalaAux as sala FROM (`reservacionesmomentaneas`) 
WHERE TipoActividadAux=1 and Fecha BETWEEN '012-01-01' and '2012-06-30'
GROUP BY SalaAux,Fecha