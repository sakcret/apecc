	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  sSearchStr.replace('_INPUT_', '<input class="buscar_dt" type="text" />') :
			  sSearchStr==="" ? '<input class="buscar_dt" type="text" />' : sSearchStr+' <input class="buscar_dt" type="text" />';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select id="ver_numreg_dt" size="1" '+sName+'>';
			var i, iLen;
